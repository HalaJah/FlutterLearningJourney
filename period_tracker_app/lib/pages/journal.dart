...
class _JournalState extends State<Journal> {
  ...
  IconData getIconByName(String iconName) {
    switch (iconName) {
      ...
      default:
        return FontAwesomeIcons.question; // Return a default icon if iconName doesn't match
    }
  }
        ...
        Scaffold(
          ...
          body: Column(
            children: [
              ...
              Padding(
                padding: EdgeInsets.fromLTRB(screenWidth * 0.05, screenWidth * 0.1, screenWidth * 0.05, screenWidth * 0.05),
                child: Stack(
                                ...
                                child: Card(
                                  ...
                                  child: ListTile(
                                        ...
                                        children: [
                                          Text(
                                            ...
                                            style: const TextStyle(
                                              ...
                                              color: Color.fromARGB(255, 113, 83, 41),
                                            ),
                                          ),
                                          const Icon(
                                    ...
                                    leading: Icon(
                                      ...
                                      size: 50,
                                      color: const Color.fromRGBO(249, 166, 194, 1),
                                    ),
                                  ),
                                ),
                              ),
